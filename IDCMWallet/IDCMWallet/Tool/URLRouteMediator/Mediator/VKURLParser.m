...
-(BOOL)parseURL:(NSURL *)url toAction:(NSString *__autoreleasing*)action toParamDic:(NSDictionary *__autoreleasing*)params;
{
    ...
    if (actionName && actionName.length > 0 &&
        ([IDCMMediatorAction instancesRespondToSelector:NSSelectorFromString(actionName)] ||
         [IDCMMediatorAction instancesRespondToSelector:NSSelectorFromString(actionNamePlus)])) {
