...
@interface IDCMBlockTableViewConfigure ()
...
@end
@implementation IDCMBlockTableViewConfigure
...
- (instancetype)configCanEditRowAtIndexPath:(void (^)(UITableView *tableView, NSIndexPath * indexPath))block {
...
@interface IDCMBlockTableView ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) IDCMBlockTableViewConfigure *configure;
@end


@implementation IDCMBlockTableView
+ (instancetype)tableViewWithFrame:(CGRect)frame
                             style:(UITableViewStyle)style
                         configure:(IDCMBlockTableViewConfigure *)configure
             headerRefreshCallback:(void(^)(void))headerRefreshCallback
             footerRefreshCallback:(void(^)(void))footerRefreshCallback {
    IDCMBlockTableView *tableView = [[self alloc] initWithFrame:frame style:style];
    [tableView addRefreshForTableViewHeaderWithKaKaHeaderBlock:headerRefreshCallback
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    ...
    self.configure.heightForHeaderInSection(tableView, section) : 0.001;
}

- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section {
    return
    self.configure.heightForFooterInSection ?
    self.configure.heightForFooterInSection(tableView, section) : 0.001;
}
