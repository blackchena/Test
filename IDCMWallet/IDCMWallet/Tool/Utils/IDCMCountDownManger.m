...
#import "IDCMCountDownManger.h"

@interface IDCMCountDownManger ()
/**
 *  计时器
 */
...
@implementation IDCMCountDownManger
- (instancetype)init
{
    self = [super init];
    if (self) {
...
-(void)dealloc{
    ...
    DDLogDebug(@"%s dealloc",object_getClassName(self));
}
@end
