...
- (HTCustomTabBarController *)HT_tabBarController {
    ...
    UIViewController *rootViewController = [window.rootViewController HT_getViewControllerInsteadIOfNavigationController];
    
    if ([rootViewController isKindOfClass:[HTCustomTabBarController class]]) {
