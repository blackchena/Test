...
- (UIViewController *)HT_popSelectTabBarChildViewControllerAtIndex:(NSUInteger)index {
    ...
    return [selectedTabBarChildViewController HT_getViewControllerInsteadIOfNavigationController];
}
...
- (UIViewController *)HT_getViewControllerInsteadIOfNavigationController {
