...
//    self.kaf_top = (self.scrollView.contentHeight <= self.scrollView.kaf_height ? self.scrollView.kaf_height : self.scrollView.contentHeight);
    
    self.kaf_top = (self.scrollView.contentHeight <= self.scrollView.kaf_height - self.scrollView.contentInset.top ? (self.scrollView.kaf_height - self.scrollView.contentInset.top) : self.scrollView.contentHeight);
}
